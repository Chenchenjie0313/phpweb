	...
	<div id="notfound">
		<div class="notfound">
			<div class="notfound-404">
				<h1>@yield('error')</h1>
				<h1 style="font-size:24px;">@yield('error_msg')</h1>
			</div>
			<h2>申し訳ありません。<br/>お探しのページが見つかりませんでした。</h2>
			<p>申し訳ございません。<br/>せっかくアクセスいただきましたが、<br/>ご指定いただいたページは、<br/>削除されているかURLが変更されている可能性がございます。</p>
			<a href="/">ホームへ</a>
		</div>
	</div>
