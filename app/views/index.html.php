...
<div class="wrapper">
  <nav class="wrapper-head navbar navbar-expand border-bottom" id="navView">
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0);" class="nav-link" data-pageid='foodMenuList' data-url="/public/upload/footMenuList.txt" data-data-type="HTML" >料理</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0);" class="nav-link" data-pageid='noticeList' data-url="/notices/list">お知らせ</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0);" class="nav-link" data-pageid='help' data-url="/public/upload/help.txt" data-data-type="HTML" >ヘルプ</a>
      </li>
    </ul>
  </nav>
      ...
      <div class="container-fluid wrapper-container">
        <div class="row" id="homeView">
          <div class="col-md-6">
              <div class="row">
                <div class="col-md-12">
                  <?php View::view('cards/mainHomeCard'); ?>
            ...
            <div class="col-md-6">
              <div class="col-md-12">
                  <?php View::view('cards/subHomeCard'); ?>
  ...
  <?php View::view('cards/footer'); ?>
  <?php View::view('cards/dialogTemplete'); ?>
  <?php View::view('cards/modalBar'); ?>
...
<script src="<?= View::js('/view/core.js'); ?>"></script>
