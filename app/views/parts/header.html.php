...
<nav id="gNavi">
  ...
  <ul id="fNavi">
  <li class="fNav03"><a href="javascript:void(0);" id="nav_qrcode" ><i class="fa fa-qrcode"></i>QRコード</a></li>
  <li class="fNav02"><a href="https://webmail21.rentalserver.jp" ><i class="fa fa-envelope"></i>メール</a></li>
  <li class="fNav04"><a href="http://www.sanyiasset.com/"><i class="fa fa-language"></i>中国語</a></li>
  </ul>
</nav>
</div>
