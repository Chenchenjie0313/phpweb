...
requirejs(['jquery', 'backbone.radio','underscore','base/baseModel','base/baseView','base/baseCollection','dialogView', 'cardView','utils'], 
    ...
    var core = new Core(indexHtmlJsonData);
